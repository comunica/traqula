...
type ToAlgebra12Transformer = ReturnType<typeof toAlgebra12Builder.build>;

export class AstToAlgebraTransformer {
  private readonly transformer: ToAlgebra12Transformer;
  public constructor() {
    this.transformer = toAlgebra12Builder.build();
  }

  public transform(query: T12.SparqlQuery, options: ContextConfigs = {}): A.Operation {
    const context = createAlgebraContext(options);
    return this.transformer.translateQuery(context, query, options.quads, options.blankToVariable);
  }
}
