...
type ToAlgebra11Transformer = ReturnType<typeof toAlgebra11Builder.build>;

export class AstToAlgebraTransformer {
  private readonly transformer: ToAlgebra11Transformer;
  public constructor() {
    this.transformer = toAlgebra11Builder.build();
  }

  public transform(query: SparqlQuery, options: ContextConfigs = {}): Algebra.Operation {
