...
BASE <ex:>
CONSTRUCT { 
  ?s0 ?p0 _:g_0 . _:g_0 <a0> _:g_1 . _:g_1 <b0> <c0> . _:g_2 <a0> _:g_3 . _:g_3 <b0> <c0> . _:g_2 ?p0 ?o0 .
}
WHERE {
  ?s1 ?p1 _:g_4 . ?s1 ?p1 <a1> . ?s1 ?q1 <b1> . ?s1 ?q1 <c1> . _:g_5 ?p2 ?o2 . ?s3 ?p3 _:g_6 . _:g_6 <a3> <b3> . ?s4 ?p4 _:g_7 . _:g_7 <a4> <b4> . _:g_7 <c4> <d4> . _:g_7 <c4> <e4> . ?s5 ?p5 _:g_8 . _:g_8 <a5> _:g_9 . _:g_9 <b5> <c5> . _:g_10 <a6> _:g_11 . _:g_11 <b6> <c6> . _:g_10 ?p6 ?o6 . _:g_12 <a7> <b7> . _:g_12 <c7> <d7> . _:g_12 <c7> <e7> .
}`);
    });
  });
