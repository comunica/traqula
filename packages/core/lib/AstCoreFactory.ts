...
export class AstCoreFactory implements AstCoreFactoryArgs {
  ...
  public readonly cachedAutoGen: SourceLocationNodeAutoGenerate = { sourceLocationType: 'autoGenerate' };
  public readonly cachedNoMat: SourceLocationNoMaterialize = { sourceLocationType: 'noMaterialize' };
  ...
  public forceMaterialized<T extends Node>(arg: T): T {
    if (arg.loc.sourceLocationType === 'noMaterialize') {
  ...
  public sourceLocationInlinedSource(
    ...
    if (subLoc.sourceLocationType === 'source') {
  ...
  public isSourceLocationInlinedSource(loc: object): loc is SourceLocationInlinedSource {
    return (<SourceLocationBase> loc).sourceLocationType === 'inlinedSource';
  }
  ...
  public isSourceLocationSource(loc: object): loc is SourceLocationSource {
    return (<SourceLocationBase> loc).sourceLocationType === 'source';
  }
  ...
  public isSourceLocationStringReplace(loc: object): loc is SourceLocationStringReplace {
    return (<SourceLocationBase> loc).sourceLocationType === 'stringReplace';
  }
  ...
  public sourceLocationNodeReplaceUnsafe(loc: SourceLocation): SourceLocationNodeReplace {
    ...
    if (loc.sourceLocationType === 'inlinedSource') {
  ...
  public isSourceLocationNodeReplace(loc: object): loc is SourceLocationNodeReplace {
    return (<SourceLocationBase> loc).sourceLocationType === 'nodeReplace';
  }
  ...
  public isSourceLocationNodeAutoGenerate(loc: object): loc is SourceLocationNodeAutoGenerate {
    return (<SourceLocationBase> loc).sourceLocationType === 'autoGenerate';
  }
  ...
  public isPrintingLoc(loc: SourceLocation): boolean {
    return loc.sourceLocationType === 'nodeReplace' ||
      loc.sourceLocationType === 'autoGenerate' ||
      (loc.sourceLocationType === 'inlinedSource' && this.isPrintingLoc(loc.loc));
  }
  ...
  public isSourceLocationNoMaterialize(loc: object): loc is SourceLocationNoMaterialize {
    return (<SourceLocationBase> loc).sourceLocationType === 'noMaterialize';
  }
