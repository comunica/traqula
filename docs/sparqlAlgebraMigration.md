...
Within SPARQLAlgebra.js the keys of a VALUES object are prefixed with a `?` (likely because this was also the case for [sparqljs](https://github.com/RubenVerborgh/SPARQL.js)), in Traqula the key is just the value/ name of the variable.
