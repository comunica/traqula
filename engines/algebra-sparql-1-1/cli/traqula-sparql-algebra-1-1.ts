...
const usage = `Usage: traqula-sparql-algebra-1-1 [options] [input]

Convert between SPARQL 1.1 query strings, AST, and SPARQL algebra.
...
Examples:
  # SPARQL to algebra
  traqula-sparql-algebra-1-1 "SELECT * WHERE { ?s ?p ?o }"
  
  # AST to algebra
  cat ast.json | traqula-sparql-algebra-1-1
  
  # Algebra to AST
  cat algebra.json | traqula-sparql-algebra-1-1 --to-ast
  
  # Algebra to SPARQL
  cat algebra.json | traqula-sparql-algebra-1-1 --to-sparql
`;
